...
จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้ = {}
จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5 = {}
...
def มาตรา128วรรค4():
    ...
    if พรรคที่มีสิทธิได้รับการจัดสรรตามมาตรา5:
        รวมจํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5 = sum(จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5.values())
        if รวมจํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5 < จํานวนสมาชิกทั้งหมดของสภาผู้แทนราษฎรแบบบัญชีรายชื่อ:
            จำนวนสสที่ต้องจัดสรรเพิ่มเติม = จํานวนสมาชิกทั้งหมดของสภาผู้แทนราษฎรแบบบัญชีรายชื่อ - รวมจํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5
            ...
            for พรรค in sorted(เศษจากการคํานวณ.items(),key = operator.itemgetter(1),reverse = True)[:จำนวนสสที่ต้องจัดสรรเพิ่มเติม]: 
               print(str(พรรค) +" +1 คน")
               จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5[พรรค[0]] = (จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5[พรรค[0]]+1)
            print(จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5)
        elif รวมจํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5 > จํานวนสมาชิกทั้งหมดของสภาผู้แทนราษฎรแบบบัญชีรายชื่อ:
            print("Error มาตรา128 วรรค4")
        else:
...
def จัดสรรสสตามมาตรา5():
    for พรรค in พรรคที่มีสิทธิได้รับการจัดสรรตามมาตรา5:
        จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้[พรรค] = คำนวณจำนวนสส(จํานวนสมาชิกสภาผู้แทนราษฎรแบบบัญชีรายชื่อที่พรรคการเมืองได้รับเบื้องต้น[พรรค])
    if sum(จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้.values()) > จํานวนสมาชิกทั้งหมดของสภาผู้แทนราษฎรแบบบัญชีรายชื่อ:
        print("จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้ ตามวรรค 5 มากกว่า 150 ต้องคำนวณตามวรรค 7 ->"+str(sum(จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้.values())))
        มาตรา128วรรค7(จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้)
    elif sum(จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้.values()) < จํานวนสมาชิกทั้งหมดของสภาผู้แทนราษฎรแบบบัญชีรายชื่อ:
        print("จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้ ตามวรรค 5 น้อยกว่า 150 ต้องคำนวณตามวรรค 6 ->"+str(sum(จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้.values())))
        มาตรา128วรรค6(จํานวนสมาชิกสภาผู้แทนราษฎรแบบบัญชีรายชื่อที่พรรคการเมืองได้รับเบื้องต้น,จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้)
    else:
        print("จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้ เท่ากับ 150 - จบการคำนวณ")
...
def มาตรา128วรรค6(จํานวนสมาชิกสภาผู้แทนราษฎรแบบบัญชีรายชื่อที่พรรคการเมืองได้รับเบื้องต้น,จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้):
 
    for พรรค in จํานวนสมาชิกสภาผู้แทนราษฎรแบบบัญชีรายชื่อที่พรรคการเมืองได้รับเบื้องต้น:
        เศษจากการคํานวณ[พรรค] = จํานวนสมาชิกสภาผู้แทนราษฎรแบบบัญชีรายชื่อที่พรรคการเมืองได้รับเบื้องต้น[พรรค] - จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้[พรรค]
        จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5[พรรค] = คำนวณจำนวนสส(จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้[พรรค])
...
def มาตรา128วรรค7(สมาชิกสภาผู้แทนราษฎรที่คำนวณได้):
     
    for พรรค in สมาชิกสภาผู้แทนราษฎรที่คำนวณได้:
        จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้[พรรค] = สมาชิกสภาผู้แทนราษฎรที่คำนวณได้[พรรค]*จํานวนสมาชิกทั้งหมดของสภาผู้แทนราษฎรแบบบัญชีรายชื่อ/sum(สมาชิกสภาผู้แทนราษฎรที่คำนวณได้.values())
        เศษจากการคํานวณ[พรรค] = จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้[พรรค] - คำนวณจำนวนสส(จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้[พรรค])
        จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5[พรรค] = คำนวณจำนวนสส(จํานวนสมาชิกสภาผู้แทนราษฎรที่คำนวณได้[พรรค])
 

def คำนวณจำนวนสส(จำนวนสสทศนิยม):
    return math.floor(จำนวนสสทศนิยม)

def รวมจำนวนสสเขตและบัญชีรายชื่อ():
    if พรรคที่มีสิทธิได้รับการจัดสรรตามมาตรา5:
        for พรรค in จำนวนสสเขตรายพรรค:
            if พรรค in จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5:
               จำนวนสสรายพรรค[พรรค] = จำนวนสสเขตรายพรรค[พรรค]+จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5[พรรค]
            else:
               จำนวนสสรายพรรค[พรรค] = จำนวนสสเขตรายพรรค[พรรค]
        for พรรค in จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5:
            if พรรค not in จำนวนสสเขตรายพรรค:
               จำนวนสสรายพรรค[พรรค] = จํานวนสมาชิกสภาผู้แทนราษฎรที่ได้รับจัดสรรคตามวรรค5[พรรค]
    else:
        #TODO
        return
...
#คำนวณ จํานวนสมาชิกสภาผู้แทนราษฎรแบบบัญชีรายชื่อที่พรรคการเมืองได้รับเบื้องต้น
...
print(จำนวนสสคำนวณต้องได้500คน(จำนวนสสรายพรรค))
